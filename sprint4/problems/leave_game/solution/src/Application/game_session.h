...
namespace app {
    ...
    public:
        ...
        //В них забиндим функции из класса Application, которые будут вызываться по сигналу
    ...
    private:
        ...
        void DeleteDogsAFKUsers();                                              //Удаление собак удаляемых юзеров

        //Паттерн "Наблюдатель" 
        //https://refactoringguru.cn/ru/design-patterns/observer
        //https://codereview.stackexchange.com/questions/216157/c-observer-pattern-via-boost-signals2
        //Данными сигналами будут вызываться методы из класса Application
