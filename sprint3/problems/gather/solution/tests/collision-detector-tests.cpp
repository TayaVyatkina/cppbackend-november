...
TEST_CASE("found item by moving along the X", FIND_GATHER_EVENTS_TAG) {
...
TEST_CASE("found item by moving along the У", FIND_GATHER_EVENTS_TAG) {
    using Catch::Matchers::WithinAbs;
...
TEST_CASE("found the item at the endpoint ", FIND_GATHER_EVENTS_TAG) {
    using Catch::Matchers::WithinAbs;
    collision_detector::Item item{ {5.0, 0}, 0.5 };                   
...
TEST_CASE("found the item while moving away from the loot", FIND_GATHER_EVENTS_TAG) {
    using Catch::Matchers::WithinAbs;
...
TEST_CASE("found several items by moving in X", FIND_GATHER_EVENTS_TAG) {
    using Catch::Matchers::WithinAbs;
...
TEST_CASE("found one of two obj by moving in X", FIND_GATHER_EVENTS_TAG) {
    using Catch::Matchers::WithinAbs;
    using Catch::Matchers::WithinRel;
    collision_detector::Item item1{ {5.0, 0.5}, 0.0 };                   
    collision_detector::Item item2{ {8.0, 0.5}, 0.0 };                    
...
TEST_CASE("2 founders, 2 obj", FIND_GATHER_EVENTS_TAG) {
    using Catch::Matchers::WithinAbs;
