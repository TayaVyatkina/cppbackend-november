...
// Для хранения информации о заказе и управления его исполнением 
...
void RunWorkers(unsigned n, const Fn& fn) {
    ...
    fn();
    // Перед выходом деструктор вектора вызовет деструкторы потоков, которые находятся в векторе.
    // И текущий поток дождётся окончания их работы.
}
