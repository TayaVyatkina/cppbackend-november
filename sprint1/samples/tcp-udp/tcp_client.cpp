...
int main(int argc, char** argv) {
    ...
    //акцептор не нужен, клиент не принимает подключений.
    ...
    // write_some завершается, когда отправлен хотя бы один байт информации
    // Дальнейшая информация продолжит отправляться в фоне.
    // Это даёт гарантию, что в момент вызова функции соединение ещё активно.
